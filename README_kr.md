...
| 솔루션 | 런타임 | CJK (JA/ZH/KO) | 네이티브 WASM | C/C++ 불필요 | 오프라인 | 라이선스 |
|---|---|---|---|---|---|---|
| **ocrs-cjk**（이 포크） | Pure Rust | Yes / Yes / Yes | Yes | Yes | Yes | Apache-2.0 / MIT |
| [ocrs](https://github.com/robertknight/ocrs)（upstream） | Pure Rust | No 라틴 문자 전용 | Yes | Yes | Yes | Apache-2.0 / MIT |
| [Tesseract](https://github.com/tesseract-ocr/tesseract) | C++（`tesseract-sys` FFI） | Yes / Yes / Yes | 부분적¹ | No | Yes | Apache-2.0 |
| [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) | Python / C++ | Yes / Yes / Yes | 부분적² | No | Yes | Apache-2.0 |
...
| [manga-ocr](https://github.com/kha-white/manga-ocr) | Python / PyTorch | 일본어 전용 | 비공식³ | 선택 | Yes | Apache-2.0 |
