...
|---|---|---|---|---|---|---|
| **ocrs-cjk**（이 포크） | Pure Rust | ✅ / ✅ / ✅ | ✅ | ✅ | ✅ | Apache-2.0 / MIT |
| [ocrs](https://github.com/robertknight/ocrs)（upstream） | Pure Rust | ❌ 라틴 문자 전용 | ✅ | ✅ | ✅ | Apache-2.0 / MIT |
| [Tesseract](https://github.com/tesseract-ocr/tesseract) | C++（`tesseract-sys` FFI） | ✅ / ✅ / ✅ | 부분적¹ | ❌ | ✅ | Apache-2.0 |
| [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) | Python / C++ | ✅ / ✅ / ✅ | 부분적² | ❌ | ✅ | Apache-2.0 |
...
| [manga-ocr](https://github.com/kha-white/manga-ocr) | Python / PyTorch | 일본어 전용 | 비공식³ | 선택 | ✅ | Apache-2.0 |
